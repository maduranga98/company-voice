    ...
    <div className="min-h-screen bg-[#f8f9fb]">
        ...
        <div className="flex items-center justify-between px-4 h-14 md:h-16 md:ml-60">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-xl bg-white/[0.08] border border-[#1ABC9C]/30 text-[#1ABC9C] text-xs font-bold hover:bg-white/[0.12] transition-colors"
            >
              {getLangCode()}
            </button>
            {/* Notification bell */}
      ...
      <div className="hidden md:flex fixed left-0 top-0 h-full w-60 bg-white border-r border-gray-200/80 z-40 flex-col shadow-sm">
        ...
        <nav className="px-3 py-3 flex-1 overflow-y-auto min-h-0 space-y-0.5">
          {/* Walls section */}
          <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 px-3 py-2">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="min-w-[20px] h-5 bg-[#FF6B6B] text-white text-xs font-bold rounded-full flex items-center justify-center px-1.5">
        ...
        <div className="px-4 py-4 border-t border-gray-100 flex-shrink-0 space-y-2">
          ...
          <button
            onClick={handleLogout}
            disabled={loggingOut}
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium text-gray-400 hover:text-red-500 hover:bg-red-50 transition-colors disabled:opacity-50"
          >
            <LogOut size={16} />
      ...
      >
        <div className="flex h-16">
          ...
          >
            ...
            <span className={`text-xs font-medium ${isWallsActive ? "text-[#1ABC9C]" : "text-gray-400"}`}>
              {t("navigation.walls", "Walls")}
            </span>
          </button>
          ...
          >
            ...
            <span className={`text-xs font-medium ${isMessagesActive ? "text-[#1ABC9C]" : "text-gray-400"}`}>
          ...
          >
            ...
            <span className={`text-xs font-medium ${isProfileActive ? "text-[#1ABC9C]" : "text-gray-400"}`}>
              {t("navigation.profile")}
            </span>
          </button>
        </div>
