...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 p-12 flex-col justify-center relative overflow-hidden" style={{ background: "linear-gradient(135deg, #2D3E50 0%, #1a2a3a 100%)" }}>
        ...
        <div className="relative z-10 max-w-lg mx-auto">
          ...
          <div className="flex items-center space-x-5 mb-12">
            <img
              src="/voxwel-logo.png"
              alt="VoxWel Logo"
              className="w-36 h-36 object-contain bg-white/20 backdrop-blur-sm rounded-2xl shadow-2xl"
            />
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">
                VoxWel
              </h1>
              <p className="font-bold text-base" style={{ color: "#1ABC9C" }}>
          ...
          <p className="text-base text-white/90 mb-12 leading-relaxed font-medium">
          ...
          <div className="space-y-4">
            {[
              {
                icon: <Lightbulb className="w-6 h-6 text-white" strokeWidth={2.5} />,
              ...
              {
                icon: <MessageSquare className="w-6 h-6 text-white" strokeWidth={2.5} />,
              ...
              <div
                key={index}
                className="flex items-start space-x-4 bg-white rounded-2xl p-5 transform hover:scale-[1.02] transition-all duration-300 shadow-sm border border-gray-100"
              >
                <div className="rounded-xl p-3 flex-shrink-0 shadow-sm" style={{ backgroundColor: "#1ABC9C" }}>
                  {feature.icon}
                </div>
                <div>
                  <h3 className="font-bold text-base mb-1" style={{ color: "#2D3E50" }}>
                    {t(feature.titleKey)}
                  </h3>
      ...
      <div className="flex-1 flex items-start justify-center p-6 sm:p-8 bg-gray-50 overflow-y-auto">
